...
class SawyerTouchCubeEnv(sawyer_env.SawyerEnv):
    def __init__(self):
        ...
        load_ros_params(rospackage_name="ur3e_openai",
                               rel_path_from_package_to_file="src/ur3e_openai/task_envs/sawyer/config",
