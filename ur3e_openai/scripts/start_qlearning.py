...
if __name__ == '__main__':
    ...
    Alpha = rospy.get_param("/ur3e/alpha")
    Epsilon = rospy.get_param("/ur3e/epsilon")
    Gamma = rospy.get_param("/ur3e/gamma")
    epsilon_discount = rospy.get_param("/ur3e/epsilon_discount")
    nepisodes = rospy.get_param("/ur3e/nepisodes")
