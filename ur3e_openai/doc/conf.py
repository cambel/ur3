# -*- coding: utf-8 -*-
#
# ur3e_openai documentation build configuration file, created by
...
htmlhelp_basename = 'ur3e_openaidoc'
...
latex_documents = [
    (master_doc, 'ur3e_openai.tex', u'openai\\_ros Documentation',
...
man_pages = [
    (master_doc, 'ur3e_openai', u'ur3e_openai Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ur3e_openai', u'ur3e_openai Documentation',
     author, 'ur3e_openai', 'One line description of project.',
     'Miscellaneous'),
]
